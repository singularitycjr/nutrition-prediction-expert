...
public class CacheService implements CachingConfigurer {//extends CachingConfigurerSupport
    ...
    public List<Object> refreshWithPipeline(String future_key,String topic_key,Collection<String> values){
        ...
        List<Object> objects = stringRedisTemplate.executePipelined(new RedisCallback<>() {
            @Nullable
            @Override
            public Object doInRedis(@Nullable RedisConnection redisConnection) throws DataAccessException {
                StringRedisConnection stringRedisConnection = (StringRedisConnection)redisConnection;
                String[] strings = values.toArray(new String[0]);
                assert stringRedisConnection != null;
